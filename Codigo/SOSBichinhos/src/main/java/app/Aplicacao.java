...
public class Aplicacao {
    ...
    public static void main(String[] args) {
        ...
        post("/enviado/update/:id", (request, response) -> enviadoService.update(request, response));
        
        post("/enviado/delete/:id", (request, response) -> enviadoService.remove(request, response));
        
        get("/enviado", (request, response) -> enviadoService.getAll(request, response));
        
        post("/enviado_gemini", (request, response) -> animalService.analise(request, response));
