...
public class GeminiVisionService {
    ...
    public static String analyzeImage(String imageUrl) throws Exception {
        ...
        String body = "{"
            ...
            + "\"parts\": ["
            + "{"
            + "\"text\": \"Analisar a imagem para identificar espécie, raça, idade, porte, temperamento, necessidades especiais, estado de saúde e características gerais, caso haja algum atributo que não seja possível analisar apenas não informe, devolva a resposta em um JSON contendo a estrutura \""
            + "},"
            + "{"
            + "\"inlineData\": {"
            + "\"mimeType\": \"" + mimeType + "\","
